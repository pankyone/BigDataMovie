...
<%@ page import="oracle.demo.oow.bd.dao.HadoopCustomerDAO" %>
<%@ page import="oracle.demo.oow.bd.dao.HadoopActivityDAO" %>
<%@ page import="oracle.demo.oow.bd.dao.HadoopGenreDAO" %>
...
<html>
  ...
  <%
    ...
    HadoopGenreDAO genreDAO = new HadoopGenreDAO();
